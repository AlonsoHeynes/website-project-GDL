    ...
    <form id="registro" class="registro" action="validar_registro.php" method="post">
        ...
        <ul class="lista-precios clearfix">
          ...
          <li>
            <div class="tabla-precio">
              ...
              <div class="orden">
                <label for="completo">Boletos deseados:</label>
     ...
     <div id="resumen" class="resumen">
       ...
       <div class="caja clearfix">
         <div class="extras">
           <div class="orden">
             <label for="camisas">Camisa del evento $10 <small>(promoción /% dto.)</small></label>
             <input type="number" min="0" id="camisas" size="3" name="pedido_camisas" placeholder="0">
           </div><!--.orden-->
           <div class="orden">
